...
function setup() {
  ...
  trex = createSprite(width/2-600,height-150,20,50);
  ...
  topbarra = createSprite(width/2, height-300,2000,10);
  topbarra.visible = false;

  invisibleGround = createSprite(width/2,height-100,2000,10);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width/2+600,height-115,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width+300,height-350,40,10);
